          ...
          <div className="sm:col-span-12 lg:col-span-3">
            <div className="mb-4">
              ...
              >
                ...
                />
                <span className="text-xl font-black leading-none text-black select-none logo mt-3">Clinical</span>
              </a>
            </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            ...
            <List>
              ...
              <ListItem className="flex gap-2">
                ...
                <span className="text-[#71717A] hover:text-gray-400 text-sm">support@clinical.com</span>
              </ListItem>
